...
**Active branch**: `dev` (round 006 **merged** — PR [#19](https://github.com/gosharplite/tellme/pull/19) → `dev` (`7cc1304`), propagated to `main`; the next round starts a fresh `007-*` off `dev`).
...
- **Round 006 delivered** — PR [#19](https://github.com/gosharplite/tellme/pull/19) merged (`7cc1304`) + propagated `dev → main`; issue [#17](https://github.com/gosharplite/tellme/issues/17) closed. **Next round starts a fresh `007-*` off `dev`**.
