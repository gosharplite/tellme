...
>
> **Propagation status (2026-09-12, session 17):** session-17 docs pushed to `dev` (`720869b`); **`dev → main` propagation PENDING** (awaiting approval).
