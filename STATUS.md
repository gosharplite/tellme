...
**Active branch**: `dev` (round 007 **delivered / propagated** — `007-session-history-persistence` → `dev` (`6f5483b`) → `main` (`c7b9950`); the next round starts a fresh `008-*` off `dev`).
