...
**Active branch**: `dev` (round 008 delivered — plan/truth PR [#24](https://github.com/gosharplite/tellme/pull/24) + implementation PR [#25](https://github.com/gosharplite/tellme/pull/25) merged into `008-agent-tools-and-tool-call-loop` (`f9b5d74`); propagated `008-agent-tools-and-tool-call-loop → dev` (`d376e03`) `→ main`). Next round starts a fresh `009-*` off `dev`.
