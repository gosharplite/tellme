...
| ADD | `docs/decisions/0043-search-files-tool.md` (+ index row) | the tool, the design-intent justification, the three deliberate divergences + three further recorded differences, and the Q1–Q3 locked choices | `spec.md` SC-004; `research.md` D7 |
