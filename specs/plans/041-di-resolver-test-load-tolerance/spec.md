...
- **SC-001**: `go test -count=20 ./...` is green **under contention** (concurrently with a full `./tests/e2e` run) — the **discriminating** criterion; a quiet-host run cannot distinguish "fixed" from "quiet". (covers FR-001, FR-004)
