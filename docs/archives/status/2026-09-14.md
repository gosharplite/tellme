...
> detail (delivered 2026-09-13), relocated **verbatim** on 2026-09-14 when round 014 became the current
> round, plus the round-013 propagation note. History is relocated, never deleted.
