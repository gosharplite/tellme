...
> through round-026** detail (delivered 2026-09-14 / 2026-09-15), relocated **verbatim** on 2026-09-15
> (round 022 when it became the current round; round 023 when round 024 became the most recent
> delivered round, then round 024 itself when round 025 became it, then round 025 when round 026
> became it, then round 026 itself when round 027 became the most recent delivered round — Rule 12).
