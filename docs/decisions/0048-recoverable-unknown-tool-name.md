...
- **RF-076-2** — the available-tools listing is unbounded beyond the loop byte clamp; a dedicated bound is possible if a huge registry ever makes it noisy.
