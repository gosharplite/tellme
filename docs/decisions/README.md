...
| [0029](0029-darwin-metrics-and-sample-cadence.md) | macOS CPU/MEM land (cgo Mach `host_statistics64` + cgo-less `runtime/metrics`; `golang.org/x/sys/unix`; reference-exact MEM) + a 1 Hz resource-sample cadence (the braille frame stays 200 ms) | Accepted |
