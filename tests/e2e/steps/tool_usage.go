...
// vacuously when a tool is added or removed (round-026 review F8).
func registeredToolNames() []string {
	reg := domaintools.NewRegistry(append(infratools.NewFilesystemTools(), infratools.NewCommandTool())...)
	tools := reg.Tools()
